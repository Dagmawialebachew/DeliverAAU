    ...
    "telegram_id": 589745233,
        ...
        "telegram_id": 577180165,
            ...
            "menu": [
                ...
                # {"id": 20, "name": "ጥብስ", "price": 250, "category": "Non Fasting"},
                # {"id": 21, "name": "ምንቸት", "price": 250, "category": "Non Fasting"},
                {"id": 18, "name": "ስጋ ፍርፍር", "price": 180, "category": "Non Fasting"},
                {"id": 19, "name": "ጥብስ ፍርፍር", "price": 250, "category": "Non Fasting"},
                ...
                # {"id": 28, "name": "ፓስታ በእንቁላል", "price": 150, "category": "Non Fasting"},
                {"id": 23, "name": "ፓስታ በስጋ", "price": 180, "category": "Non Fasting"},
                {"id": 24, "name": "ስፔሻል ፍርፍር (የፍስክ)", "price": 300, "category": "Non Fasting"},
                # {"id": 32, "name": "እንቁላል በስጋ", "price": 200, "category": "Non Fasting"},
                {"id": 25, "name": "ሙሉ አገልግል (የፍስክ)", "price": 400, "category": "Non Fasting"},
                {"id": 26, "name": "ፍርፍር በቅቤ", "price": 150, "category": "Non Fasting"},
                # {"id": 35, "name": "ምስር በስጋ", "price": 180, "category": "Non Fasting"},
                # {"id": 36, "name": "ምስር በእንቁላል", "price": 150, "category": "Non Fasting"},
                {"id": 27, "name": "አይብ", "price": 200, "category": "Non Fasting"},
                {"id": 28, "name": "ስፔሻል ኮርኒስ (የጾም)", "price": 300, "category": "Specials"},
                {"id": 29, "name": "ምንትዋብ", "price": 200, "category": "Specials"},
                {"id": 30, "name": "ይምጡ በዝና", "price": 250, "category": "Specials"},
            ],
        },
        {
